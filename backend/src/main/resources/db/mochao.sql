...
CREATE TABLE IF NOT EXISTS t_practice_session (
    ...
    mode             VARCHAR(20)   DEFAULT 'copy' COMMENT '练习模式: copy-1:1抄写 summary-摘要写作',
    ...
    summary_content  TEXT          DEFAULT NULL COMMENT '摘要内容',
    self_written_content TEXT      DEFAULT NULL COMMENT '自写内容',
    created_at       DATETIME      DEFAULT CURRENT_TIMESTAMP,
    updated_at       DATETIME      DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS t_collection (
    ...
    type          VARCHAR(20)  DEFAULT 'sentence' COMMENT '类型: word-好词 sentence-好句',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='网文榜单快照';
